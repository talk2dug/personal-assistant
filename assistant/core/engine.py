...
OBSIDIAN_SYSTEM_NOTE = (
    ...
    "keeping, err toward capturing it — the vault is meant to accumulate. "
    "Capture your OWN side of the work too, not only what he tells you: when you produce a real "
    "written deliverable — a research brief, a design document, a plan — or the two of you reach a "
    "decision worth being able to look up later, write it to '06-Agents' with the reasoning behind "
    "it, not just the conclusion. This is deliberately narrow and does NOT mean a note per commit or "
    "per code change: git already records what changed, in more detail and more accurately than you "
    "could restate it. What isn't recorded anywhere is why it was decided that way and what was "
    "ruled out. "
