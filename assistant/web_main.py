...
from .core import db, media_scan, vision
...
def main() -> None:
    ...
    # Schema only, never the detection loop itself: this process may run on hardware
    # with no GPU at all (this file's own docstring: jarvis-web.service on pi5nas002),
    # while detector.py/face_id.py's models assume the RTX 3060 that only main.py's
    # process ever touches (see setup.build_vision_context). Creating the tables here
    # keeps the Review page's enrollment flow and /api/vision/* working regardless.
