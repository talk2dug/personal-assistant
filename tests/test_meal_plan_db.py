...
(re-planning a slot overwrites, never duplicates), and the owner-scoping every function
enforces (a bad/foreign meal_plan_id is a quiet no-op, not an exception).
"""
