...
class SendtoSilhouette(EffectExtension):
    ...
    def detect_doc_regmark(self):
        ...
        # Wrapped in try/except to handle inkex bounding_box errors with certain SVG structures
        try:
            ...
            self.report(f"Could not auto-detect regmarks from SVG: {e}. Using command-line values instead.", 'log')
